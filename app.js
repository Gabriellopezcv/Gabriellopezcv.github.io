// ==========================================
// 1. MOTOR GRÁFICO (FONDO ANIMADO ARREGLADO)
// ==========================================
...
// BUG SOLUCIONADO AQUÍ: Usamos cw y ch
...
const fraseFilosofica = "La información quiere ser libre. Todo lo que te ocultan, está aquí.";
const decrypter = new TextScramble(document.getElementById('motto'));
setTimeout(() => { decrypter.setText(fraseFilosofica); }, 500);

// ==========================================
// 3. LA BASE DE DATOS DE FILTRACIONES REALES
// ==========================================
const baseDeDatos = {
    wikileaks: [
        {
            titulo: "Vault 7: Herramientas de Hacking de la CIA",
            origen: "WIKILEAKS_RELEASE", fecha: "2017.03.07",
        ...
        },
        {
            ...
            origen: "WIKILEAKS_RELEASE", fecha: "2010.04.05",
    ...
    nsa: [
        {
            ...
            origen: "SNOWDEN_LEAKS", fecha: "2013.06.06",
        ...
        },
        {
            ...
            origen: "SNOWDEN_LEAKS", fecha: "2013.07.31",
    ...
    uap: [
        {
            ...
            origen: "DEPT_OF_DEFENSE", fecha: "2020.04.27",
...
// ==========================================
// 4. LÓGICA DE INTERFAZ Y RENDERIZADO
// ==========================================
    ...
    if (categoria === 'inicio') {
        ...
        grid.innerHTML = `
            <div style="text-align: center; padding: 50px 20px; max-width: 800px; margin: 0 auto;">
                ...
                <p style="font-family: 'Space Mono', monospace; font-size: 1.1rem; line-height: 1.8; color: #a0b2c6;">Para evadir los rastreadores gubernamentales y corporativos, esta terminal ha sido desconectada de la red global.</p>
                <p style="font-family: 'Space Mono', monospace; font-size: 1.1rem; line-height: 1.8; margin-top: 15px; color: #a0b2c6;">Todos los documentos clasificados que verás a continuación están pre-cargados en la memoria caché local de tu navegador. Navega sin dejar rastro.</p>
                <div style="margin-top: 40px; padding: 20px; border: 1px dashed #ff003c; background: rgba(255, 0, 60, 0.05); display: inline-block;">
                    <p style="color: #ff003c; font-weight:bold;">SELECCIONE UNA CARPETA DESCLASIFICADA EN EL MENÚ SUPERIOR.</p>
                </div>
            </div>
        `;
        return;
    ...
    articulos.forEach((art, index) => {
        grid.innerHTML += `
            <article class="article-card" onclick="abrirArticulo('${categoria}', ${index})">
                ...
                <h2 class="card-title" style="font-family: 'Rajdhani', sans-serif; font-size: 1.3rem; color: #fff; margin-bottom: 10px;">${art.titulo}</h2>
                <p class="card-excerpt" style="font-size: 0.85rem; color: #a0b2c6; line-height: 1.5; font-family: 'Space Mono', monospace; flex-grow:1;">${art.resumen}</p>
...
// ==========================================
// 5. SECUENCIA DE ARRANQUE VISUAL
// ==========================================
    ...
    const intervalo = setInterval(() => {
        ...
        if(progreso >= 100) {
            ...
            setTimeout(() => {
                ...
                categoryNav.classList.remove('hidden'); // Muestra el menú de las fugas
